    ...
    def handle(self, *args, **options):
        ...
        posts_data = [
            ...
            },
            {
                ...
                'content': 'Введение в язык программирования Python для новичков.',
                'author': user,
                'category': Category.objects.get(name='Программирование')
            },
            {
                'title': 'Путешествие в Японию',
                'content': 'Мои впечатления от поездки в Токио и Киото.',
                'author': user,
                'category': Category.objects.get(name='Путешествия')
            },
            {
                'title': 'Рецепт салата Цезарь',
                'content': 'Классический рецепт салата Цезарь с курицей.',
                'author': user,
                'category': Category.objects.get(name='Кулинария')
            },
            {
                'title': 'Django ORM основы',
                'content': 'Изучаем основы работы с ORM в Django.',
                'author': user,
                'category': Category.objects.get(name='Программирование')
            },
            {
                'title': 'Отдых на Бали',
                'content': 'Советы по отдыху на острове Бали.',
                'author': user,
                'category': Category.objects.get(name='Путешествия')
            },
        ]
